...
#line 251
extern double erfc(double arg_0x40376e88) __attribute((__nothrow__)) ;
...
static inline void RandomInitialise(int arg_0x405ed618, int arg_0x405ed770);
static double RandomUniform(void );
...
# 77 "/opt/tinyos-2.1.0/tos/interfaces/AMPacket.nc"
...
{
  LedsP$Led2$set();
  sim_log_debug(122U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 100
  ;
}
...
{
  LedsP$Led1$set();
  sim_log_debug(119U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 85
  ;
}
...
{
  LedsP$Led0$set();
  sim_log_debug(116U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 70
  ;
}
...
#line 104
{
  sim_log_debug(112U, "RadioCountToLedsC", "Received packet from %hhu.\n", RadioCountToLedsC$AMPacket$source(bufPtr));
  sim_log_debug(113U, "RadioCountToLedsC", "Received packet of length %hhu.\n", len);
...
# 89 "/opt/tinyos-2.1.0/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x409046a8, message_t * msg, error_t error){
#line 89
  switch (arg_0x409046a8) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x409046a8, msg, error);
#line 89
      break;
#line 89
    }
...
# 99 "/opt/tinyos-2.1.0/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x40835c70, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x40835c70, msg, error);
#line 99
}
#line 99
...
#line 68
# 74 "/opt/tinyos-2.1.0/tos/lib/tossim/TossimPacketModelC.nc"
static inline tossim_metadata_t *TossimPacketModelC$getMetadata(message_t *msg)
#line 74
{
...
#line 44
# 69 "/opt/tinyos-2.1.0/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x409030a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x409030a0, addr, msg, len);
#line 69
...
#line 83
{
  ...
  sim_log_debug(124U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(125U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(126U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(127U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 83
{
  ...
  sim_log_debug(110U, "RadioCountToLedsC", "RadioCountToLedsC: timer fired, counter is %hu.\n", RadioCountToLedsC$counter[sim_node()]);
...
#line 91
      ...
      __nesc_hton_uint16(rcm->counter.data, RadioCountToLedsC$counter[sim_node()]);
...
# 72 "/opt/tinyos-2.1.0/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b3f3a8){
#line 72
  switch (arg_0x40b3f3a8) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b3f3a8);
#line 72
      break;
#line 72
    }
...
#line 46
  {
    sim_log_debug(114U, "Init", "LEDS: initialized.\n");
...
#line 65
{
  sim_log_debug(109U, "Boot", "Node %d Booted.\n", TOS_NODE_ID);
  RadioCountToLedsC$AMControl$start();
}
